...
function toastMarkdown(){
	...
	const editor = new Editor({
		...
		initialValue: $('.md-editor-field').val(),
		...
		events: {
			keyup: function() {
			  ...
			  $('.md-editor-field').val(editor.getMarkdown());
			}
		}
	  });
}

function toastMarkdownPresentation(){
...
// 	el: document.querySelector('.md-editor-view'),
// 	height: '500px',
// 	// initialEditType: 'markdown',
// 	initialValue: $('.md-editor-view').val(),
